...
class KinectView(App):
    ...
    def build(self):
        ...
        self.stopButton.bind(on_press=lambda x:self.on_press_stopButton())
        ...
        self.startButton.bind(on_press=lambda x:self.on_press_startButton())
...
#        self.backwardButton = Button(background_normal="backward.png", size_hint=(None, None), size=(100, 50), pos=(235, 740), border=(0, 0, 0, 0))
 #       self.backwardButton.bind(on_press=lambda x:self.on_press_backwardButton())
  #      layout.add_widget(self.backwardButton)
